    ...
    resources: {
        ...
        ua: {
          translations: {
            ...
            "Stress": "Стрес",
            "Depression": "Депресія",
            "Your parameters are below": "Ваші параметри нижче. ",
            "Your weight looks good. ":"Ваша вага в нормі. ",
            "Obesity might cause productivy loss and depression. ":" Зайва вага можете знижувати продуктивність та викликати депресію. ",
            "Heart rate over normal might be caused by stress. ":"Підвищення пульсу може бути викликано стресом. ",
            "Your cardiovascular system looks okay. ": "Ваша сердцевососудиста система в нормі. ",
            "We strongly advise a visit to a therapist. ":"Ми рекомендуємо побачитися з психологом. ",
            "Your mental health is good. ":"Ваше ментальнє здоровя в порядку. ",
